...
class EventController extends Controller
{
     ...
     *         "programTitle" = "^(?!edit|delete|process).*$"
     * })
    ...
    /**
     * Endpoint to spawn a job to calculate and store statistics for the event.
     ...
     * @param KernelInterface $kernel Provided by Symfony dependency injection.
     ...
     * @codeCoverageIgnore
     */
    public function generateStatsAction(KernelInterface $kernel, $eventId)
    {
        $application = new Application($kernel);
        $application->setAutoExit(false);

        $input = new ArrayInput([
            'command' => 'app:process-event',
            'eventId' => $eventId,
        ]);
    }
}
