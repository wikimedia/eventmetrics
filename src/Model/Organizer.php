 ...
 * )
 * @ORM\EntityListeners({"App\EventSubscriber\OrganizerSubscriber"})
 */
class Organizer {
	/**
	 * @ORM\Id
	 ...
	 * @var int|null Corresponds to the `gu_id` column in `centralauth`.`globaluser`.
	 */
	protected ?int $userId = null;

	/**
	 * @var string|null Username retrieved using the $userId.
	 */
	 ...
	 */
	public function __construct( string|int $usernameOrId ) {
