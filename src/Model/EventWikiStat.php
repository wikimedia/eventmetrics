...
use App\Model\Traits\StatTrait;
...
class EventWikiStat {
	 ...
	 * @var int|null Offset value for the metric, if applicable (e.g. num days retention).
	 ...
	 */
	public function __construct( EventWiki $wiki, string $metric, mixed $value, ?int $offset = null ) {
		$this->wiki = $wiki;
