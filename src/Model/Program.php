 ...
 * )
 * @ORM\EntityListeners({"App\EventSubscriber\ProgramSubscriber"})
 */
class Program {
	/**
	 ...
	 * @ORM\GeneratedValue
	 * @var int|null Unique ID of the program.
	 */
	 ...
	 * @var string|null The title of the program.
	 */
	 ...
	 */
	protected Collection $organizers;
	...
	public function getOrganizerIds(): array {
		return $this->organizers->map( static function ( Organizer $organizer ) {
	...
	public function sortOrganizers( string $primary ): void {
		...
		usort( $nonPrimaryOrgs, static function ( Organizer $a, Organizer $b ) {
	...
	public function getEventIds(): array {
		return $this->events->map( static function ( Event $event ) {
			return $event->getId();
		} )->toArray();
	}
	 ...
	 */
	public function getStatistic( string $metric ): mixed {
