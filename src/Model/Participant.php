...
class Participant {
	 ...
	 * @var int|null Corresponds to the `gu_id` column in `centralauth`.`globaluser` on the replicas.
	 */
	 ...
	 */
	protected bool $newEditor = false;

	/**
	 * Event constructor.
	 * @param Event $event Event the Participant is participating in.
	 * @param int|null $userId ID of the user, corresponds with `centralauth`.`globaluser`.
	 */
